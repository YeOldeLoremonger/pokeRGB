...
$(pokegreen_obj):	   RBGASMFLAGS += -D _GREEN
...
$(foreach obj, $(pokegreen_vc-obj), $(eval $(call DEP,$(obj),$(obj:_green_vc.o=.asm))))
...
pokegreen_opt	   = -jsv -n 0 -k 01 -1 0x33 -m 0x13 -r 03 -t "POKEMON GREEN"
