...
; Characteristics of each move.
	...
	move GUST,         NO_ADDITIONAL_EFFECT,        40, BIRD,         100, 35
	move WING_ATTACK,  NO_ADDITIONAL_EFFECT,        35, BIRD,         100, 35
	...
	move QUICK_ATTACK, NO_ADDITIONAL_EFFECT,        40, BIRD,         100, 30
	...
	move EGG_BOMB,     NO_ADDITIONAL_EFFECT,       100, BIRD,          75, 10
	...
	move SWIFT,        SWIFT_EFFECT,                60, BIRD,         100, 20
	...
	move UPPER_CUT,    SLEEP_EFFECT,     		   100, FIGHTING,	   95, 15
	move CAT_NAIL,	   TWO_TO_FIVE_ATTACKS_EFFECT,	35, NORMAL,		   85, 10
	move HYDRO_JET,    FLINCH_SIDE_EFFECT1,		   150, WATER,		   95,  3
	move MEGAFIRE,	   BURN_SIDE_EFFECT2,		   150, FIRE,		   95,  3
	move YUCKY,		   BURN_SIDE_EFFECT2,		   150, POISON,		   95,  3
	move ELECTROCUTE,  BURN_SIDE_EFFECT2,		   150, ELECTRIC,	   95,  3
	move POWDER_SNOW,  FREEZE_SIDE_EFFECT,		    40, ICE,          100, 30
	move FIREBALL,	   BURN_SIDE_EFFECT1,		    55, FIRE,		  100, 25
	move PARASCISSOR,  PARALYZE_SIDE_EFFECT2,	   150, BUG,		   95,  3
	move BYEBYEPUNCH,  OHKO_EFFECT,					40, FIGHTING, 	   65, 10
	move MEGATONKICK,  FLINCH_SIDE_EFFECT1,		   150, NORMAL,        95,  3
	move TAIL_SWIPES,  TWO_TO_FIVE_ATTACKS_EFFECT,  55, NORMAL,		   85,  5
	move LUNGE,		   SLEEP_EFFECT,				80, BUG,		   95, 10
	move TENMAN_VOLT,  PARALYZE_SIDE_EFFECT1,		20, ELECTRIC,	  100, 35
	move FIFTYMANVOLT, PARALYZE_SIDE_EFFECT2,	   100, ELECTRIC,     100, 10
	move PUNCH,		   NO_ADDITIONAL_EFFECT,		15, FIGHTING,	  100, 40
	move KARATE, 	   NO_ADDITIONAL_EFFECT,		30, FIGHTING,     100, 25
	move BEAK_BASH,    ATTACK_TWICE_EFFECT,         30, BIRD,		   85, 20
	move HONEY_FLAME,  LEECH_SEED_EFFECT,			25, FIRE,		  100, 30
	move POISONEEDLE,  POISON_EFFECT,			   150, GRASS,		   95,  3
	move SCALD,		   BURN_SIDE_EFFECT2,			70, WATER,        100, 15
	move MOLT_SHELL,   SUBSTITUTE_EFFECT,			30, BUG,		  100,  5
	move FLOOD,		   OHKO_EFFECT,					50, WATER,		   65,  5
	move LANDSLIDE,    PARALYZE_EFFECT,				80, GROUND,        70,  5
	move TRANSPARENT,  LIGHT_SCREEN_EFFECT,			20, BUG,          100, 25
	move PORTCULLIS,   DEFENSE_UP2_EFFECT,			40, ROCK,   	  100, 15
	move PSYCULLIS,	   REFLECT_EFFECT,				40, PSYCHIC_TYPE, 100, 15
	move KENETICWALL,  TRAPPING_EFFECT,				30, PSYCHIC_TYPE,  95, 15
	move SQUID_INK,	   ACCURACY_DOWN1_EFFECT,		30, WATER,		  100, 25
	move DOUBLEBACK,   HEAL_EFFECT,					15, NORMAL,		  100, 15
	move DIVE_BOMB,	   FLY_EFFECT,					65, FIRE,		   95, 15	
	move BARK,		   CONFUSION_EFFECT,			 5, NORMAL,		  100, 25
	move PSYNAMI,	   DEFENSE_DOWN2_EFFECT,	   100, PSYCHIC_TYPE,  95,  3
	move JUMP,		   HYPER_BEAM_EFFECT,		   150, NORMAL,        95,  3
	move WHIRLPOOL,    FLY_EFFECT,				   140, WATER,		   95,  5
