Route13_Object:
	...
	def_object_events
	object_event 49, 10, SPRITE_COOLTRAINER_M, WALK, UP_DOWN, 1, OPP_BIRD_KEEPER, 1
	object_event 48, 10, SPRITE_COOLTRAINER_F, WALK, LEFT_RIGHT, 2, OPP_JR_TRAINER_F, 12
	...
	object_event 50,  5, SPRITE_COOLTRAINER_F, WALK, ANY_DIR, 5, OPP_JR_TRAINER_F, 15
