SSAnneB1FRooms_Object:
	...
	def_object_events
	object_event  0, 13, SPRITE_SAILOR, WALK, ANY_DIR, 1, OPP_SAILOR, 3
	object_event  2, 11, SPRITE_SAILOR, WALK, ANY_DIR, 1, OPP_SAILOR, 4
	object_event 12,  3, SPRITE_SAILOR, WALK, ANY_DIR, 3, OPP_SAILOR, 5
	object_event 22,  1, SPRITE_SAILOR, WALK, UP_DOWN, 4, OPP_SAILOR, 6
	object_event  0,  2, SPRITE_SAILOR, WALK, ANY_DIR, 5, OPP_SAILOR, 7
	object_event  0,  4, SPRITE_FISHER, WALK, LEFT_RIGHT, 6, OPP_FISHER, 2
	object_event 10, 13, SPRITE_SUPER_NERD, STAY, RIGHT, 7 ; person
	object_event 11, 12, SPRITE_MONSTER, WALK, ANY_DIR, 8 ; person
