VictoryRoad3F_Object:
	...
	def_object_events
	object_event 28,  5, SPRITE_COOLTRAINER_M, WALK, ANY_DIR, 1, OPP_COOLTRAINER_M, 2
	object_event  7, 13, SPRITE_COOLTRAINER_F, WALK, ANY_DIR, 2, OPP_COOLTRAINER_F, 2
	object_event  6, 14, SPRITE_COOLTRAINER_M, WALK, ANY_DIR, 3, OPP_COOLTRAINER_M, 3
	object_event 13,  3, SPRITE_COOLTRAINER_F, WALK, ANY_DIR, 4, OPP_COOLTRAINER_F, 3
