FuchsiaCity_Object:
	...
	object_event 30, 14, SPRITE_FISHER, WALK, UP_DOWN, 3 ; person
	object_event 24,  8, SPRITE_YOUNGSTER, STAY, UP, 4 ; person
	object_event 31,  5, SPRITE_FAIRY, WALK, ANY_DIR, 5 ; person
	object_event 25,  6, SPRITE_POKE_BALL, WALK, ANY_DIR, 6 ; person
	object_event 12,  6, SPRITE_MONSTER, WALK, ANY_DIR, 7 ; person
	object_event 30, 12, SPRITE_MONSTER, WALK, ANY_DIR, 8 ; person
	object_event  8, 17, SPRITE_SEEL, WALK, ANY_DIR, 9 ; person
	object_event  6,  5, SPRITE_FOSSIL, WALK, LEFT_RIGHT, 10 ; person
