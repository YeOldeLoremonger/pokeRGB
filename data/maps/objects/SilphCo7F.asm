SilphCo7F_Object:
	...
	object_event 13, 13, SPRITE_SILPH_WORKER, WALK, LEFT_RIGHT, 2 ; person
	object_event  7, 10, SPRITE_SILPH_WORKER, STAY, NONE, 3 ; person
	object_event 10,  8, SPRITE_ERIKA, WALK, UP_DOWN, 4 ; person
	object_event  9,  4, SPRITE_ROCKET, WALK, ANY_DIR, 5, OPP_ROCKET, 32
	object_event  5, 13, SPRITE_SCIENTIST, WALK, UP_DOWN, 6, OPP_SCIENTIST, 8
	object_event 20,  2, SPRITE_ROCKET, WALK, ANY_DIR, 7, OPP_ROCKET, 33
	object_event 19, 14, SPRITE_ROCKET, WALK, ANY_DIR, 8, OPP_ROCKET, 34
