MtMoon1F_Object:
	...
	object_event 12, 16, SPRITE_YOUNGSTER, WALK, ANY_DIR, 2, OPP_YOUNGSTER, 3
	object_event 30,  4, SPRITE_COOLTRAINER_F, WALK, ANY_DIR, 3, OPP_LASS, 5
	object_event 24, 31, SPRITE_SUPER_NERD, WALK, ANY_DIR, 4, OPP_SUPER_NERD, 1
	object_event 16, 23, SPRITE_COOLTRAINER_F, WALK, ANY_DIR, 5, OPP_LASS, 6
	...
	object_event 21, 33, SPRITE_POKE_BALL, STAY, NONE, 12, POTION
