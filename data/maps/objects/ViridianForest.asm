ViridianForest_Object:
	...
	object_event 30, 33, SPRITE_YOUNGSTER, WALK, ANY_DIR, 2, OPP_BUG_CATCHER, 1
	object_event 30, 19, SPRITE_YOUNGSTER, WALK, LEFT_RIGHT, 3, OPP_BUG_CATCHER, 2
	object_event  2, 18, SPRITE_YOUNGSTER, WALK, LEFT_RIGHT, 4, OPP_BUG_CATCHER, 3
