VermilionCity_Object:
	...
	bg_event 29, 13, 13 ; VermilionCityText13

	def_object_events
	object_event 19,  7, SPRITE_BEAUTY, WALK, UP_DOWN, 1 ; person
	object_event 14,  6, SPRITE_GAMBLER, WALK, LEFT_RIGHT, 2 ; person
	object_event 19, 30, SPRITE_SAILOR, STAY, UP, 3 ; person
	object_event 30,  7, SPRITE_GAMBLER, WALK, ANY_DIR,  4 ; person
