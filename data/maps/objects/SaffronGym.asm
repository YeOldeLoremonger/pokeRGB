SaffronGym_Object:
	...
	def_object_events
	object_event  9,  8, SPRITE_GIRL, WALK, ANY_DIR, 1, OPP_SABRINA, 1
	object_event 10,  1, SPRITE_CHANNELER, WALK, ANY_DIR, 2, OPP_CHANNELER, 22
	object_event 17,  1, SPRITE_YOUNGSTER, WALK, ANY_DIR, 3, OPP_PSYCHIC_TR, 1
	object_event  3,  7, SPRITE_CHANNELER, WALK, ANY_DIR, 4, OPP_CHANNELER, 23
	object_event 17,  7, SPRITE_YOUNGSTER, WALK, ANY_DIR, 5, OPP_PSYCHIC_TR, 2
	object_event  3, 13, SPRITE_CHANNELER, WALK, ANY_DIR, 6, OPP_CHANNELER, 24
	object_event 17, 13, SPRITE_YOUNGSTER, WALK, ANY_DIR, 7, OPP_PSYCHIC_TR, 3
	object_event  3,  1, SPRITE_YOUNGSTER, WALK, ANY_DIR, 8, OPP_PSYCHIC_TR, 4
	object_event 10, 15, SPRITE_GYM_GUIDE, WALK, ANY_DIR, 9 ; person
