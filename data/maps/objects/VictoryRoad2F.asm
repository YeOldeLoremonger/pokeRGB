VictoryRoad2F_Object:
	...
	def_object_events
	object_event 12,  9, SPRITE_HIKER, WALK, ANY_DIR, 1, OPP_BLACKBELT, 9
	object_event 21, 13, SPRITE_SUPER_NERD, WALK, UP_DOWN, 2, OPP_JUGGLER, 2
	object_event 19,  8, SPRITE_COOLTRAINER_M, WALK, ANY_DIR, 3, OPP_TAMER, 5
	object_event  4,  2, SPRITE_SUPER_NERD, WALK, UP_DOWN, 4, OPP_POKEMANIAC, 6
	object_event 26,  3, SPRITE_SUPER_NERD, WALK, LEFT-RIGHT, 5, OPP_JUGGLER, 5
	object_event 11,  5, SPRITE_BIRD, WALK, ANY_DIR, 6, MOLTRES, 50 | OW_POKEMON
