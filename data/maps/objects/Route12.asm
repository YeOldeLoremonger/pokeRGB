Route12_Object:
	...
	object_event 14, 76, SPRITE_SUPER_NERD, WALK, ANY_DIR, 5, OPP_ROCKER, 2
	object_event 12, 40, SPRITE_FISHER, WALK, ANY_DIR, 6, OPP_FISHER, 5
	object_event  9, 52, SPRITE_FISHER, WALK, ANY_DIR, 7, OPP_FISHER, 6
	object_event  6, 87, SPRITE_FISHER, WALK, ANY_DIR, 8, OPP_FISHER, 11
	object_event 14, 35, SPRITE_POKE_BALL, WALK, ANY_DIR, 9, TM_PAY_DAY
