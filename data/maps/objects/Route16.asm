Route16_Object:
	...
	warp_event 24,  9, ROUTE_16_GATE_1F, 4
	...
	bg_event 11, 15, 9 ; Route16Text9

	def_object_events
	object_event 17, 12, SPRITE_BIKER, STAY, LEFT, 1, OPP_BIKER, 5
	object_event 14, 13, SPRITE_BIKER, WALK, ANY_DIR, 2, OPP_CUE_BALL, 1
	object_event 11, 12, SPRITE_BIKER, WALK, ANY_DIR, 3, OPP_CUE_BALL, 2
	object_event  9, 11, SPRITE_BIKER, WALK, ANY_DIR, 4, OPP_BIKER, 6
	object_event  6, 10, SPRITE_BIKER, WALK, ANY_DIR, 5, OPP_CUE_BALL, 3
	object_event  3, 12, SPRITE_BIKER, WALK, ANY_DIR, 6, OPP_BIKER, 7
