IndigoPlateauLobby_Object:
	...
	warp_event 14,  0, LORELEIS_ROOM, 1

	def_bg_events

	def_object_events
	object_event  7,  5, SPRITE_NURSE, STAY, DOWN, 1 ; person
	object_event  6,  9, SPRITE_GYM_GUIDE, WALK, ANY_DIR, 2 ; person
	object_event 13,  1, SPRITE_COOLTRAINER_F, STAY, DOWN, 3 ; person
	object_event  0,  3, SPRITE_CLERK, STAY, RIGHT, 4 ; person
