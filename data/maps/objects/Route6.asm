Route6_Object:
	...
	object_event  0, 15, SPRITE_YOUNGSTER, WALK, ANY_DIR, 3, OPP_BUG_CATCHER, 10
	object_event 11, 31, SPRITE_COOLTRAINER_M, STAY, LEFT, 4, OPP_JR_TRAINER_M, 5
	object_event 11, 30, SPRITE_COOLTRAINER_F, WALK, ANY_DIR, 5, OPP_JR_TRAINER_F, 3
	object_event 19, 26, SPRITE_YOUNGSTER, WALK, ANY_DIR, 6, OPP_BUG_CATCHER, 11
