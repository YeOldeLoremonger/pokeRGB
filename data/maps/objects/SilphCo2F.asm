SilphCo2F_Object:
	...
	object_event  5, 12, SPRITE_SCIENTIST, WALK, ANY_DIR, 2, OPP_SCIENTIST, 2
	object_event 24, 13, SPRITE_SCIENTIST, WALK, ANY_DIR, 3, OPP_SCIENTIST, 3
	object_event 16, 11, SPRITE_ROCKET, WALK, ANY_DIR, 4, OPP_ROCKET, 23
	object_event 24,  7, SPRITE_ROCKET, WALK, ANY_DIR, 5, OPP_ROCKET, 24
