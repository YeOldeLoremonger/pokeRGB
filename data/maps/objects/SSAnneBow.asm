SSAnneBow_Object:
	...
	object_event  4,  9, SPRITE_SAILOR, WALK, ANY_DIR, 2 ; person
	object_event  7, 11, SPRITE_COOLTRAINER_M, STAY, NONE, 3 ; person
	object_event  4,  4, SPRITE_SAILOR, WALK, ANY_DIR, 4, OPP_SAILOR, 1
	object_event 10,  8, SPRITE_SAILOR, WALK, UP_DOWN, 5, OPP_SAILOR, 2
