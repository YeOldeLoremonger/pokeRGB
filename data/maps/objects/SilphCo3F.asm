SilphCo3F_Object:
	...
	def_object_events
	object_event 24,  8, SPRITE_SILPH_WORKER, WALK, UP_DOWN, 1 ; person
	object_event 20,  7, SPRITE_ROCKET, WALK, ANY_DIR, 2, OPP_ROCKET, 25
	object_event  7,  9, SPRITE_SCIENTIST, WALK, ANY_DIR, 3, OPP_SCIENTIST, 4
