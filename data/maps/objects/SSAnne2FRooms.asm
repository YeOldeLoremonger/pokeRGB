SSAnne2FRooms_Object:
	...
	def_object_events
	object_event 10,  2, SPRITE_GENTLEMAN, WALK, LEFT_RIGHT, 1, OPP_GENTLEMAN, 3
	object_event 15,  4, SPRITE_FISHER, WALK, LEFT_RIGHT, 2, OPP_FISHER, 1
	object_event  0, 14, SPRITE_GENTLEMAN, WALK, LEFT_RIGHT, 3, OPP_GENTLEMAN, 5
	object_event  2, 11, SPRITE_COOLTRAINER_F, WALK, UP_DOWN, 4, OPP_LASS, 12
	object_event  1,  2, SPRITE_GENTLEMAN, STAY, DOWN, 5 ; person
	object_event 12,  1, SPRITE_POKE_BALL, STAY, NONE, 6, MAX_ETHER
	object_event 20,  2, SPRITE_GENTLEMAN, STAY, DOWN, 7 ; person
	...
	object_event 10, 13, SPRITE_LITTLE_BOY, WALK, ANY_DIR, 11 ; person
	object_event 22, 12, SPRITE_BRUNETTE_GIRL, WALK, LEFT_RIGHT, 12 ; person
	object_event 20, 12, SPRITE_BEAUTY, WALK, LEFT_RIGHT, 13 ; person
