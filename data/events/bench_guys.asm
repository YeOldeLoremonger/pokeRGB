...
BenchGuyTextPointers:
    ...
    bench_guy_text SAFARI_ZONE_NORTH_REST_HOUSE, SPRITE_FACING_LEFT, SafariZoneNorthRestHouseGuyText
    bench_guy_text SAFARI_ZONE_WEST_REST_HOUSE,  SPRITE_FACING_LEFT, SafariZoneWestRestHouseGuyText
    bench_guy_text SAFARI_ZONE_EAST_REST_HOUSE,  SPRITE_FACING_LEFT, SafariZoneEastRestHouseGuyText
	db -1 ; end
