...
ENDC
IF DEF(_GREEN)
	RGB 31,29,31, 30,30,17, 09,20,11, 20,26,31 ; PAL_LOGO1
ENDC
...
ENDC
IF DEF(_GREEN)
	RGB 31,29,31, 31,31,17, 09,20,11, 03,02,02 ; PAL_SLOTS2
	RGB 31,29,31, 22,31,16, 09,20,11, 03,02,02 ; PAL_SLOTS3
	RGB 31,29,31, 25,17,21, 09,20,11, 03,02,02 ; PAL_SLOTS4
ENDC
