...
; Cinnabar Gym
	...
	db 34, PONYTA, CHARMANDER, VULPIX, PONYTA, 0
	db 41, RAPIDASH, 0
	db 37, PONYTA, VULPIX, 0
...
BurglarData:
; Unused
	db 29, PONYTA, VULPIX, 0
	db 33, PONYTA, 0
	db 28, VULPIX, CHARMANDER, PONYTA, 0
; Cinnabar Gym
	db 36, PONYTA, VULPIX, NINETALES, 0
	db 41, PONYTA, 0
	db 37, VULPIX, PONYTA, 0
; Mansion 2F
...
; Victory Road 3F
	db 43, EXEGGUTOR, CLOYSTER, RAPIDASH, 0
...
BlaineData:
	db $FF, 42, PONYTA, 40, PONYTA, 42, RAPIDASH, 47, RAPIDASH, 0

SabrinaData:
	db $FF, 38, KADABRA, 37, MR_MIME, 38, BUTTERFREE, 43, ALAKAZAM, 0

GentlemanData:
; SS Anne 1F Rooms
	db 18, PONYTA, PONYTA, 0
...
; Unused
	db 48, PRIMEAPE, 0
; SS Anne 2F Rooms
	db 17, PONYTA, PONYTA, 0

Green2Data:
; SS Anne 2F
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, MEW, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, DRAGONAIR, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, EEVEE, 0
; Pokémon Tower 2F
	db $FF, 25, PIDGEOTTO, 23, PONYTA, 22, EXEGGCUTE, 20, KADABRA, 25, MEW, 0
	db $FF, 25, PIDGEOTTO, 23, GYARADOS, 22, PONYTA, 20, KADABRA, 25, DRAGONAIR, 0
	db $FF, 25, PIDGEOTTO, 23, EXEGGCUTE, 22, GYARADOS, 20, KADABRA, 25, EEVEE, 0
; Silph Co. 7F
	db $FF, 37, PIDGEOT, 38, PONYTA, 35, EXEGGCUTE, 35, ALAKAZAM, 40, MEW, 0
	db $FF, 37, PIDGEOT, 38, GYARADOS, 35, PONYTA, 35, ALAKAZAM, 40, DRAGONITE, 0
	db $FF, 37, PIDGEOT, 38, EXEGGCUTE, 35, GYARADOS, 35, ALAKAZAM, 40, FLAREON, 0
; Route 22
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, PONYTA, 47, EXEGGCUTE, 50, ALAKAZAM, 53, MEW, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, GYARADOS, 47, PONYTA, 50, ALAKAZAM, 53, DRAGONITE, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, EXEGGCUTE, 47, GYARADOS, 50, ALAKAZAM, 53, JOLTEON, 0

Green3Data:
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, RAPIDASH, 63, EXEGGUTOR, 65, MEW, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, GYARADOS, 63, RAPIDASH, 65, DRAGONITE, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, GYARADOS, 65, VAPOREON, 0
